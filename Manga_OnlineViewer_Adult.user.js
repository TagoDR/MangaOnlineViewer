...
(function() {
  ...
  function setKeyDownEvents() {
    ...
    function processKey(e) {
      const a = e.code;
      if ($.inArray(a, ['KeyW', 'Numpad8', 'KeyS', 'Numpad2', 'ArrowRight', 'Period', 'KeyD', 'Numpad6', 'ArrowLeft', 'Comma', 'KeyA', 'Numpad4', 'Equal', 'NumpadAdd', 'Minus', 'NumpadSubtract', 'Digit9', 'NumpadDivide', 'Digit0', 'NumpadMultiply', 'Slash', 'Numpad5']) !== -1) {
        e.preventDefault();
        e.stopPropagation();
