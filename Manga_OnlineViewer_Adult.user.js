  ...
  function formatPage(manga, begin = 0) {
    ...
    if (manga.quant > 0) {
      ...
      if (!settings.alwaysLoad) {
        $('head').append('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.11.5/sweetalert2.min.css" integrity="sha256-0AEO0dmdWUZ8e17VwaCiLJ1k8VlFQq2jGRetjpVCr34=" crossorigin="anonymous" />');
        swal({
