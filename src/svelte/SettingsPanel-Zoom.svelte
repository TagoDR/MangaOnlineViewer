...
<div class="ControlLabel DefaultZoomMode">
  ...
  <select id="DefaultZoomMode" onchange={changeDefaultZoomMode} value={$settings.zoomMode}>
...
>
  <span>
    {$locale.DEFAULT_ZOOM}
    <output class="RangeValue" for="DefaultZoom" id="defaultZoomVal">
...
<div class="ControlLabel minZoom">
  <span>
    {$locale.MINIMUM_ZOOM}
    <output class="RangeValue" for="minZoom" id="minZoomVal">
      {$settings.minZoom}%
    </output>
  </span>
  <input
...
<div class="ControlLabel zoomStep">
  <span>
    {$locale.ZOOM_STEP}
    <output class="RangeValue" for="zoomStep" id="zoomStepVal">
      {$settings.zoomStep}%
    </output>
  </span>
  <input
...
<div class="ControlLabel viewMode">
  ...
  <select id="viewMode" onchange={changeViewMode} value={$settings.viewMode}>
