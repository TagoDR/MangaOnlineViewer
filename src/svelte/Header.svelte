...
<header class="{$settings.header} headroom-top" id="Header">
  <aside id="GlobalFunctions">
    ...
    <span id="ZoomSlider">
      <output class="RangeValue" for="Zoom" id="ZoomVal">
  ...
  <div class="ViewerTitle">
    ...
    <a href={manga.series} id="series" onclick={buttonRedirectURL}>
      ({$locale.RETURN_CHAPTER_LIST})
    </a>
  </div>
  <nav id="ChapterNavigation">
    <div class="ControlLabel" id="Counters">
      {$locale.PAGES_LOADED}:
      <i>0</i> /
    ...
    <div class="ChapterControl" id="ChapterControl">
      <button
