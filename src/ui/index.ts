...
// @ts-expect-error
import('https://early.webawesome.com/webawesome@3.0.0/dist/components/button/button.js');
import(
  // @ts-expect-error
...
// @ts-expect-error
import('https://early.webawesome.com/webawesome@3.0.0/dist/components/drawer/drawer.js');
// @ts-expect-error
import('https://early.webawesome.com/webawesome@3.0.0/dist/components/dialog/dialog.js');
// @ts-expect-error
import('https://early.webawesome.com/webawesome@3.0.0/dist/components/slider/slider.js');
// @ts-expect-error
import('https://early.webawesome.com/webawesome@3.0.0/dist/components/icon/icon.js');
import(
  // @ts-expect-error
  'https://early.webawesome.com/webawesome@3.0.0/dist/components/dropdown/dropdown.js'
);
// @ts-expect-error
import('https://early.webawesome.com/webawesome@3.0.0/dist/webawesome.js').then(wa => {
