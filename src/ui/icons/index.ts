...
export { default as IconPlayerStop } from './player-stop.svg';
export { default as IconClockPlus } from './clock-plus.svg';
export { default as IconClockMinus } from './clock-minus.svg';
export { default as IconElevator } from './elevator.svg';
export { default as IconElevatorOff } from './elevator-off.svg';
