...
import { buttonBookmark } from '../../ui/events/bookmarks';
import { buttonHidePage, buttonReloadPage } from '../../ui/events/individual';
import {
  buttonRestoreZoom,
  buttonZoomHeight,
  buttonZoomIn,
...
function MangaPage({ index, src = '' }: Props) {
  ...
  return (
    <div id={`Page${index}`} className="MangaPage">
      ...
      <div className="PageContent">
        <img id={`PageImg${index}`} alt="" className="PageImg" src={src} />
      </div>
    </div>
  );
}
