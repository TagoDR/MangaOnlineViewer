...
import { changeLocale, changeSettingsScope } from '../../ui/events/options';
  ...
  return (
    <>
      <div className="ControlLabel">
        {l.SCOPE}
        <div id="SettingsScope" className="radio-inputs">
      ...
      <div className="ControlLabel locale">
        {l.LANGUAGE}
        <select id="locale" value={s.locale} onChange={changeLocale}>
          {locales.map((loc) => (
