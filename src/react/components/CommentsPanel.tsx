...
function CommentsPanel() {
  ...
  return (
    <section id="CommentsPanel" className="panel">
      <button
        id="CloseComments"
      ...
      <h2>{l.COMMENTS}</h2>
      <div id="CommentsArea" className={s.colorScheme}></div>
      <button id="CommentsColorScheme" className="simpleButton ColorScheme" type="button">
        <IconSun />
        <IconMoon />
      </button>
    </section>
