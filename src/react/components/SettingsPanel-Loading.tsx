...
import { changeLoadMode, changePagesPerSecond } from '../../ui/events/options';
  ...
  return (
    <>
      <div className="ControlLabel loadMode">
        {l.DEFAULT_LOAD_MODE}
        <select id="loadMode" value={s.loadMode} onChange={changeLoadMode}>
      ...
      <div className="ControlLabel PagesPerSecond">
        {l.LOAD_SPEED}
        <select id="PagesPerSecond" value={s.throttlePageLoad} onChange={changePagesPerSecond}>
