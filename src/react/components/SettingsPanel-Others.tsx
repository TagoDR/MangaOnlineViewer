  ...
  return (
    <>
      ...
      <div className="ControlLabel showThumbnails">
        {l.SHOW_THUMBNAILS}
        <Toggler name="showThumbnails" checked={s.showThumbnails} onChange={checkShowThumbnails} />
      </div>

      <div className="ControlLabel enableComments">
        {l.ENABLE_COMMENTS}
        <Toggler name="enableComments" checked={s.enableComments} onChange={checkEnableComments} />
      </div>

      <div className="ControlLabel downloadZip">
        {l.DOWNLOAD_IMAGES}
        <Toggler name="downloadZip" checked={s.downloadZip} onChange={checkAutoDownload} />
      </div>
      ...
      <div className="ControlLabel lazyLoadImages">
        ...
        <Toggler name="lazyLoadImages" checked={s.lazyLoadImages} onChange={checkLazyLoad} />
      </div>

      <div className={`ControlLabel lazyStart ControlLabelItem ${s.lazyLoadImages ? 'show' : ''}`}>
        <span>
          {l.LAZY_LOAD_IMAGES}
          <output id="lazyStartVal" htmlFor="lazyStart">
            {s.lazyStart}
          </output>
        </span>
        <input
      ...
      <div className="ControlLabel autoScroll">
        <span>
          ...
          <output id="scrollHeightVal" htmlFor="scrollHeight">
            {s.scrollHeight}
          </output>
          px
        </span>
      ...
      <div className="ControlLabel headerType">
        {l.HEADER_TYPE}
        <select id="headerType" value={s.header} onChange={changeHeaderType}>
