...
import { changeMinZoom, changeZoomStep } from '../../ui/events/options';
import { changeViewMode } from '../../ui/events/viewmode';
import { changeDefaultZoom, changeDefaultZoomMode } from '../../ui/events/zoom';
  ...
  return (
    <>
      <div className="ControlLabel DefaultZoomMode">
        {l.DEFAULT_ZOOM_MODE}
        <select id="DefaultZoomMode" value={s.zoomMode} onChange={changeDefaultZoomMode}>
      ...
      >
        <span>
          {l.DEFAULT_ZOOM}
          <output id="defaultZoomVal" className="RangeValue" htmlFor="DefaultZoom">
            {s.defaultZoom}%
          </output>
        </span>
        <input
      ...
      <div className="ControlLabel minZoom">
        <span>
          {l.MINIMUM_ZOOM}
          <output id="minZoomVal" className="RangeValue" htmlFor="minZoom">
            {s.minZoom}%
          </output>
        </span>
        <input
      ...
      <div className="ControlLabel zoomStep">
        <span>
          {l.ZOOM_STEP}
          <output id="zoomStepVal" className="RangeValue" htmlFor="zoomStep">
            {s.zoomStep}%
          </output>
        </span>
        <input
      ...
      <div className="ControlLabel viewMode">
        {l.DEFAULT_VIEW_MODE}
        <select id="viewMode" value={s.viewMode} onChange={changeViewMode}>
