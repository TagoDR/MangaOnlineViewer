...
import { toggleAutoScroll } from '../../ui/events/autoscroll';
import { buttonBookmarksOpen } from '../../ui/events/bookmarks';
import {
  buttonCommentsOpen,
  buttonGlobalHideImageControls,
  buttonRedirectURL,
  buttonStartDownload,
} from '../../ui/events/globals';
import { selectGoToPage } from '../../ui/events/navigation';
import { buttonKeybindingsOpen, buttonSettingsOpen } from '../../ui/events/panels';
import { updateViewMode } from '../../ui/events/viewmode';
import { changeGlobalZoom, changeZoom, changeZoomByStep } from '../../ui/events/zoom';
import {
...
function Header({ manga }: Props) {
  ...
  return (
    <>
      ...
      <header id="Header" className={`${s.header} headroom-top`}>
        ...
        <div className="ViewerTitle">
          ...
          <a id="series" href={manga.series ?? ''} onClick={buttonRedirectURL}>
        ...
        <nav id="ChapterNavigation">
          <div id="Counters" className="ControlLabel">
            ...
            <select id="gotoPage" onChange={selectGoToPage}>
