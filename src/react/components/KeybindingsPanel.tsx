...
import { buttonKeybindingsClose, editKeybindings, saveKeybindings } from '../../ui/events/panels';
...
function KeybindingsPanel() {
  ...
  return (
    <div id="KeybindingsPanel" className="panel">
      <h2>{l.KEYBINDINGS}</h2>
      <button
        id="CloseKeybindings"
