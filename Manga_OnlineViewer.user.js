...
(function() {
  ...
  var mangadex = {
    ...
    run() {
      let api = null;
      const url = 'https://mangadex.org/api/chapter/' + String(location.pathname.match(/[0-9]+/)[0]);
      $.ajax({
        type: 'GET',
        url,
        async: false,
      ...
      return {
        ...
        listImages: api.page_array.map(img => String(api.server + api.hash) + '/' + String(img))
      };
    }
  };
  ...
  var mangarock = {
    ...
    run() {
      let api = null;
      const url = 'https://api.mangarockhd.com/query/web401/pages?oid=' + String(location.pathname.match(/mrs-chapter-[0-9]+/)[0]);
      $.ajax({
        type: 'GET',
        url,
        async: false,
      ...
      function process(mri) {
        ...
        return 'data:image/webp;base64,' + String(btoa(e.join('')));
      }
