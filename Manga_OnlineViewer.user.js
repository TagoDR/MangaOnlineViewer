...
(function (W) {
    ...
    function reader() {
        var reader =
            ...
            "        <a class='prev' name='prev' href='" + Manga.prev + "' onclick='location=\"" + Manga.prev + "\";location.reload();'>Previous</a>" +
            "        <a class='next' name='next' href='" + Manga.next + "' onclick='location=\"" + Manga.next + "\";location.reload();'>Next</a>" +
            "    </div>" +
