...
// @include /https?:\/\/(www.)?tmofans.com\/viewer\/.+\/paginated/
...
(function() {
  ...
  var mangadex = {
    ...
    run() {
      let api = null;
      const url = "https://mangadex.cc/api/chapter/".concat(W.location.pathname.match(/[0-9]+/)[0]);
      $.ajax({
        type: 'GET',
        url,
        async: false,
