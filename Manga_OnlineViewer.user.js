...
function controls$1() {
  ...
  $('#loadMode').change(event => {
    ...
    logScript('MangaLoadMode: ' + String(getValueGM('MangaLoadMode')));
  });
...
function lateStart(manga, begin = 1) {
  ...
  Swal.fire({
    ...
    if (result.value) {
      logScript('Choice: ' + String(result.value));
      W.stop();
  ...
  if (manga.quant > 0) {
    ...
    switch (settings.loadMode) {
      ...
      case 'normal':
        Swal.fire({
          title: 'Starting MangaOnlineViewer',
          text: (beginnig > 1 ? 'Resuming reading from Page ' + beginnig + '.\n' : '') + 'Please wait, 3 seconds...',
          showCancelButton: true,
          cancelButtonColor: '#d33',
          reverseButtons: true,
          timer: 3000
