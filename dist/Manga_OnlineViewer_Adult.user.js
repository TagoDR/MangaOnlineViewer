...
(function () {
  ...
  function h$2(i) {
    void 0 !== this._$AN ? (o$a(this), (this._$AM = i), r$4(this)) : (this._$AM = i);
  }
  function n$5(i, t = false, e = 0) {
    ...
    if (void 0 !== h && 0 !== h.size)
      if (t)
        if (Array.isArray(r)) for (let i = e; i < r.length; i++) (s$2(r[i], false), o$a(r[i]));
        else null != r && (s$2(r, false), o$a(r));
      else s$2(this, i);
  }
  const c$2 = i => {
      ...
      class extends f$1 {
        ...
        rt(t) {
          if ((this.isConnected || (t = void 0), 'function' == typeof this.G)) {
            ...
            let s = o$9.get(i);
            (void 0 === s && ((s = new WeakMap()), o$9.set(i, s)),
        ...
        get lt() {
          return 'function' == typeof this.G
            ? o$9.get(this.ht ?? globalThis)?.get(this.G)
            : this.G?.value;
        }
        disconnected() {
  ...
  let n$3 = class n {
    ...
    get styleSheet() {
      ...
      if (e$5 && void 0 === t) {
        ...
        (e && (t = o$8.get(s)),
          void 0 === t &&
            ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), e && o$8.set(s, t)));
      }
      return t;
    }
    toString() {
  ...
  const o$6 = s.litElementPolyfillSupport;
  o$6?.({ LitElement: i$1 });
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */ const o$5 = { attribute: true, type: String, converter: u, reflect: false, hasChanged: f },
    r$1 = (t = o$5, e, r) => {
  ...
  `;
  __decorateClass$a([n$1({ type: String })], ColorPanel.prototype, 'selectedTheme', 2);
  ColorPanel = __decorateClass$a([t$1('mov-color-panel')], ColorPanel);
  ...
  `;
  __decorateClass$9([n$1({ type: Array })], SegmentedControl.prototype, 'options', 2);
  __decorateClass$9([n$1({ type: String })], SegmentedControl.prototype, 'value', 2);
  __decorateClass$9([n$1({ type: String })], SegmentedControl.prototype, 'labelPosition', 2);
  SegmentedControl = __decorateClass$9([t$1('mov-segmented-control')], SegmentedControl);
  ...
  `;
  __decorateClass$8([n$1({ type: String })], ToggleSwitch.prototype, 'name', 2);
  __decorateClass$8([n$1({ type: Boolean, reflect: true })], ToggleSwitch.prototype, 'checked', 2);
  __decorateClass$8([n$1({ attribute: false })], ToggleSwitch.prototype, 'onChange', 2);
  ToggleSwitch = __decorateClass$8([t$1('mov-toggle-switch')], ToggleSwitch);
  ...
  `;
  __decorateClass$7([n$1({ type: Number })], Pagination.prototype, 'currentPage', 2);
  __decorateClass$7([n$1({ type: Number })], Pagination.prototype, 'totalPages', 2);
  __decorateClass$7([n$1({ type: Number })], Pagination.prototype, 'startPage', 2);
  __decorateClass$7([n$1({ type: String })], Pagination.prototype, 'next', 2);
  __decorateClass$7([n$1({ type: String })], Pagination.prototype, 'prev', 2);
  Pagination = __decorateClass$7([t$1('mov-pagination')], Pagination);
  ...
  `;
  __decorateClass$6([n$1({ type: Boolean, reflect: true })], Panel.prototype, 'open', 2);
  __decorateClass$6([n$1({ type: String, reflect: true })], Panel.prototype, 'mode', 2);
  __decorateClass$6([n$1({ type: String, reflect: true })], Panel.prototype, 'position', 2);
  __decorateClass$6([e$2('dialog')], Panel.prototype, 'dialog', 2);
  Panel = __decorateClass$6([t$1('mov-panel')], Panel);
    ...
    render() {
      ...
      >
        <button
          ...
          slot="action"
        >
          ${isBookmarked() === void 0 ? IconBookmark : IconBookmarkOff}
        </button>
  ...
  BookmarkPanel = __decorateClass$5(
    [t$1('mov-bookmark-panel'), libExports.useStores(settings$2, locale, appState)],
    BookmarkPanel,
  );
  ...
  KeybindingsPanel = __decorateClass$4(
    [t$1('mov-keybindings-panel'), libExports.useStores(settings$2, locale, appState)],
    KeybindingsPanel,
  );
  ...
  Navbar.styles = [
    ...
    i$3`
      ...
      .Thumbnail .ThumbnailImg:not([src]) {
        background-image: url('${r$3(svgToUrl(IconPhotoRaw))}');
      }

      .Thumbnail .ThumbnailImg.imgBroken {
        background-image: url('${r$3(svgToUrl(IconPhotoOffRaw))}');
      }
    `,
  ];
  ...
  Navbar = __decorateClass$3(
    [t$1('mov-navbar'), libExports.useStores(settings$2, locale, appState)],
    Navbar,
  );
  ...
  CommentsPanel = __decorateClass$2(
    [t$1('mov-comments-panel'), libExports.useStores(settings$2, locale, appState)],
    CommentsPanel,
  );
  ...
  SettingsPanel.styles = [r$3(settings)];
  SettingsPanel = __decorateClass$1(
    [t$1('mov-settings-panel'), libExports.useStores(settings$2, locale, appState)],
    SettingsPanel,
  );
  ...
  function isMouseInsideRegion(event, headerWidth, headerHeight2) {
    return (
      event.clientX >= 0 &&
...
`;
  ...
  let App = class extends i$1 {
    ...
    render() {
      ...
      >
        ...
        ${getSettingsValue('navbar') === 'disabled' ? '' : x$1`<mov-navbar .mode=${getSettingsValue('navbar')}></mov-navbar>`}
        ${
  ...
  App = __decorateClass(
    [t$1('manga-online-viewer'), libExports.useStores(settings$2, locale, appState)],
    App,
  );
