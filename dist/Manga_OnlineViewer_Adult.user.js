...
`;
  ...
  * {
  ...
  __vitePreload(() => import('https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.0.0/dist-cdn/components/button/button.js'),false             ?__VITE_PRELOAD__:void 0);
  ...
  __vitePreload(() => import('https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.0.0/dist-cdn/components/drawer/drawer.js'),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import('https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.0.0/dist-cdn/components/dialog/dialog.js'),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import('https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.0.0/dist-cdn/components/slider/slider.js'),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import('https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.0.0/dist-cdn/components/icon/icon.js'),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.0.0/dist-cdn/components/dropdown/dropdown.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import('https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.0.0/dist-cdn/webawesome.js'),false             ?__VITE_PRELOAD__:void 0).then((wa) => {
  ...
  async function preparePage([site, manga]) {
    ...
    document.head.innerHTML += '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.0.0/dist-cdn/styles/webawesome.css" />';
