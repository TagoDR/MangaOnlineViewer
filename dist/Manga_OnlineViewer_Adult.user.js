...
(function () {
  ...
  function M(n) {
    ((!n.__d && (n.__d = true) && i$1.push(n) && !$.__r++) || r$1 != l$1.debounceRendering) &&
  ...
  function O(n, u, t, i, r, o, e, f, c, s) {
    ...
    n: if ('function' == typeof j)
      try {
        ...
        ((h.state = h.__s),
          null != h.getChildContext && (i = d$1(d$1({}, i), h.getChildContext())),
  ...
  ((n = v$1.slice),
    ...
    (x.prototype.setState = function (n, l) {
      var u;
      ((u =
        null != this.__s && this.__s != this.state ? this.__s : (this.__s = d$1({}, this.state))),
  ...
  function KeybindingsPanel() {
    const l = useStore(locale);
    const s = useStore(settings$1);
    const [editor, setEditor] = d(false);
    const handleEdit = () => {
      editKeybindings();
      setEditor(true);
    };
