...
// @require       https://cdn.jsdelivr.net/npm/hotkeys-js@4.0.2/dist/hotkeys.min.js
...
(function () {
  ...
  function toKebabCase(name) {
    ...
    const withoutPrefix = name.startsWith("Icon") ? name.substring(4) : name;
    const kebabCased = withoutPrefix.trim().replace(/([A-Z]+)([A-Z][a-z])/g, "$1-$2").replace(/([a-z\d])([A-Z])/g, "$1-$2").toLowerCase();
    return kebabCased;
  }
  ...
  ], Icon.prototype, "variant", 2);
  __decorateClass$j([
    n$1({ type: String, reflect: true })
  ], Icon.prototype, "family", 2);
  __decorateClass$j([
    n$1({ type: String })
  ...
  __decorateClass$b([
    n$1({ type: String, reflect: true })
  ], Switch.prototype, "design", 2);
  __decorateClass$b([
    n$1({ type: String })
  ], Switch.prototype, "textOn", 2);
  __decorateClass$b([
    n$1({ type: String })
  ], Switch.prototype, "textOff", 2);
  Switch = __decorateClass$b([
    t$1("mov-switch")
  ], Switch);
      ...
      >
        ...
        <div id="ZoomControl">
          <wa-slider
            ...
            with-markers
            with-tooltip
            label="Zoom : ${getSettingsValue("zoomMode") === "percent" ? `${getSettingsValue("zoomValue")}%` : getSettingsValue("zoomMode")}"
          >
          </wa-slider>
        </div>
        <div
    ...
    render() {
      ...
      >
        ...
        <div
          ...
          slot="header-actions"
        >
          ${getAppStateValue("panel") === "keybindingsEditor" ? b$1` <wa-button
                id="SaveKeybindings"
                type="button"
...
`;
  ...
  * {
  ...
  const tablerResolver = (name) => `https://cdn.jsdelivr.net/npm/@tabler/icons/icons/${toKebabCase(name)}.svg`;
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/components/button/button.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/components/button-group/button-group.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/components/color-picker/color-picker.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/components/drawer/drawer.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/components/dialog/dialog.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/components/slider/slider.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/components/switch/switch.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/components/icon/icon.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import(
    // @ts-expect-error
    'https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/components/dropdown/dropdown.js'
  ),false             ?__VITE_PRELOAD__:void 0);
  __vitePreload(() => import('https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/webawesome.js'),false             ?__VITE_PRELOAD__:void 0).then(
    (wa) => {
      wa.setBasePath("https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/");
      wa.registerIconLibrary("default", {
        resolver: (name, family, _variant) => {
          const customIcon = family === "unstyled" ? rawIcons[toPascalCase(name)] : styledIcons$1[toPascalCase(name)];
          if (customIcon) {
  ...
  async function preparePage([site, manga]) {
    ...
    document.head.innerHTML += '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/styles/webawesome.css" />';
