...
(function () {
    ...
    for (let i = 0; i < s; i++) {
      ...
      l +=
        c === f$3
          ? s + n$6
          : d >= 0
            ? (o.push(a), s.slice(0, d) + e$6 + s.slice(d) + h$3 + x)
            : s + h$3 + (-2 === d ? i : x);
    }
  ...
  ColorPanel = __decorateClass$5([t$1('mov-color-panel')], ColorPanel);
  ...
  `;
  __decorateClass$4([n$1({ type: Array })], SegmentedControl.prototype, 'options', 2);
  __decorateClass$4([n$1({ type: String })], SegmentedControl.prototype, 'value', 2);
  __decorateClass$4([n$1({ type: String })], SegmentedControl.prototype, 'labelPosition', 2);
  SegmentedControl = __decorateClass$4([t$1('mov-segmented-control')], SegmentedControl);
  ...
  `;
  __decorateClass$3([n$1({ type: String })], ToggleSwitch.prototype, 'name', 2);
  __decorateClass$3([n$1({ type: Boolean, reflect: true })], ToggleSwitch.prototype, 'checked', 2);
  __decorateClass$3([n$1({ attribute: false })], ToggleSwitch.prototype, 'onChange', 2);
  ToggleSwitch = __decorateClass$3([t$1('mov-toggle-switch')], ToggleSwitch);
  ...
  appState.listen((value, _oldValue, changedKey) => {
    if (changedKey === 'scrollToPage' && value.scrollToPage !== void 0) {
      ...
      setAppStateValue('scrollToPage', void 0);
    }
  });
  ...
  `;
  __decorateClass$2([n$1({ type: Number })], Pagination.prototype, 'currentPage', 2);
  __decorateClass$2([n$1({ type: Number })], Pagination.prototype, 'totalPages', 2);
  __decorateClass$2([n$1({ type: Number })], Pagination.prototype, 'startPage', 2);
  __decorateClass$2([n$1({ type: String })], Pagination.prototype, 'next', 2);
  __decorateClass$2([n$1({ type: String })], Pagination.prototype, 'prev', 2);
  Pagination = __decorateClass$2([t$1('mov-pagination')], Pagination);
...
`;
  ...
  const keybindsRefs = Object.keys(getSettingsValue('keybinds')).reduce((acc, key) => {
    acc[key] = e$4();
    return acc;
  }, {});
  const keybindList = () => {
  ...
  const listPages = (times, begin) =>
    sequence(times, begin).map(index => {
      if (!getAppStateValue('images')?.[index].ref) {
        changeImage(index, _image => ({ ref: e$4() }));
      }
      return x$1`
      <div
        id="Page${index}"
