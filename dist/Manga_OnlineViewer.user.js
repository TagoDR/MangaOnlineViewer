...
(function () {
  ...
  const t$4 = globalThis,
    i$5 = t => t,
    s$3 = t$4.trustedTypes,
    e$8 = s$3 ? s$3.createPolicy('lit-html', { createHTML: t => t }) : void 0,
    h$3 = '$lit$',
    o$c = `lit$${Math.random().toFixed(9).slice(2)}$`,
    n$6 = '?' + o$c,
    r$7 = `<${n$6}>`,
    l$1 = document,
    c$3 = () => l$1.createComment(''),
    a$1 = t => null === t || ('object' != typeof t && 'function' != typeof t),
    u$1 = Array.isArray,
    d$2 = t => u$1(t) || 'function' == typeof t?.[Symbol.iterator],
    f$2 = '[ \t\n\f\r]',
    v = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
    _$1 = /-->/g,
    m = />/g,
    ...
    for (let i = 0; i < s; i++) {
          ...
          c === v
            ? '!--' === u[1]
              ...
              : void 0 !== u[1]
                ? (c = m)
                : void 0 !== u[2]
                  ? (y$1.test(u[2]) && (n = RegExp('</' + u[2], 'g')), (c = p$1))
                  : void 0 !== u[3] && (c = p$1)
            : c === p$1
              ? '>' === u[0]
                ? ((c = n ?? v), (d = -1))
      ...
      l +=
        c === v
          ? s + r$7
          : d >= 0
            ? (e.push(a), s.slice(0, d) + h$3 + s.slice(d) + o$c + x)
            : s + o$c + (-2 === d ? i : x);
    }
            ...
            for (const t of r.getAttributeNames())
              if (t.endsWith(h$3)) {
                ...
                d.push({
                  ...
                  r.removeAttribute(t);
              } else t.startsWith(o$c) && (d.push({ type: 6, index: l }), r.removeAttribute(t));
          if (y$1.test(r.tagName)) {
            const t = r.textContent.split(o$c),
              i = t.length - 1;
            if (i > 0) {
              r.textContent = s$3 ? s$3.emptyScript : '';
              for (let s = 0; s < i; s++)
                r.append(t[s], c$3()), P.nextNode(), d.push({ type: 2, index: ++l });
              r.append(t[i], c$3());
            }
          }
        } else if (8 === r.nodeType)
          if (r.data === n$6) d.push({ type: 2, index: l });
          else {
            let t = -1;
            for (; -1 !== (t = r.data.indexOf(o$c, t + 1)); )
              d.push({ type: 7, index: l }), (t += o$c.length - 1);
          }
        l++;
      }
    }
  ...
  class R {
    ...
    u(t) {
      const {
        ...
        e = (t?.creationScope ?? l$1).importNode(i, true);
      P.currentNode = e;
      let h = P.nextNode(),
        o = 0,
        n = 0,
  ...
  class k {
    ...
    $(t) {
      const { values: i, _$litType$: s } = t,
        e =
          'number' == typeof s
            ? this._$AC(t)
            : (void 0 === s.el && (s.el = S$1.createElement(V(s.h, s.h[0]), this.options)), s);
    ...
    k(t) {
      ...
      for (const h of t)
        e === i.length
          ? i.push((s = new k(this.O(c$3()), this.O(c$3()), this, this.options)))
          : (s = i[e]),
          s._$AI(h),
          e++;
  ...
  class H {
    ...
    _$AI(t, i = this, s, e) {
      ...
      let o = false;
      if (void 0 === h)
        (t = M(this, t, i, 0)), (o = !a$1(t) || (t !== this._$AH && t !== E)), o && (this._$AH = t);
      else {
        const e = t;
        let n, r;
  ...
  B?.(S$1, k), (t$4.litHtmlVersions ??= []).push('3.3.2');
  const D = (t, i, s) => {
  ...
  const es_ES = {
    ...
    DOWNLOAD_INCOMPLETE_MESSAGE:
      'Algunas páginas no se pudieron descargar y se saltaron. Se ha añadido una lista de páginas fallidas al archivo ZIP.',
  ...
  function compareSettingsCustomizer(value, other, key) {
    ...
    if (key === 'keybinds') {
      return areKeybindsEqual(value, other);
    }
    return void 0;
  }
   ...
   */ let e$1 = class e extends i$4 {
    ...
    render(r) {
      ...
      const s = [r];
      return (
        (s.raw = s), (this._t = { _$litType$: this.constructor.resultType, strings: s, values: [] })
      );
    }
  };
  ...
  `;
  __decorateClass$c([n$1({ type: String, reflect: true })], SegmentedControl.prototype, 'value', 2);
  ...
  `;
  __decorateClass$9([n$1({ type: String })], Pagination.prototype, 'mode', 2);
  ...
  Pagination = __decorateClass$9([t$1('manga-pagination')], Pagination);
  ...
  `;
  __decorateClass$8([n$1({ type: Boolean, reflect: true })], Drawer.prototype, 'open', 2);
  __decorateClass$8([n$1({ type: String, reflect: true })], Drawer.prototype, 'placement', 2);
  __decorateClass$8([e$2('dialog')], Drawer.prototype, 'dialog', 2);
  Drawer = __decorateClass$8([t$1('mov-drawer')], Drawer);
  ...
  function requireLib() {
    ...
    (function (exports$1) {
      ...
      exports$1.withStores =
        exports$1.useStores =
        exports$1.MultiStoreController =
        exports$1.StoreController =
          void 0;
      var StoreController_1 = requireStoreController();
      Object.defineProperty(exports$1, 'StoreController', {
        enumerable: true,
        get: function () {
      ...
      Object.defineProperty(exports$1, 'MultiStoreController', {
        enumerable: true,
        get: function () {
      ...
      Object.defineProperty(exports$1, 'useStores', {
        enumerable: true,
        get: function () {
      ...
      Object.defineProperty(exports$1, 'withStores', {
        enumerable: true,
        get: function () {
  ...
  const SettingsPanelOthers = () =>
    b$1`${checkboxOptions()} ${pagination()} ${lazyLoad()} ${headerType()} ${navbarType()} ${autoScroll()}`;
  ...
  const SettingsPanelZoom = () =>
    b$1`${defaultZoomMode()} ${zoomValue()} ${minZoom()} ${zoomStep()} ${viewMode()}`;
  ...
  * {
  ...
  const mangaball = {
    ...
    run: async () => {
      ...
      const allChapters = (data.ALL_CHAPTERS || []).sort((a, b) => b.number_float - a.number_float);
      const findChapter = direction => {
        const currentNumberFloat = parseFloat(chapterNumber || '0');
        const currentIndex = allChapters.findIndex(
          chap => chap.number_float === currentNumberFloat,
        );
